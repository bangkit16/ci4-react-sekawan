...
function Employees() {
  ...
  return (
    <DashboardLayout pageTitle="Employees" breadcrumb="Dashboard · Employees">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {data?.data.map((employee: Employee) => {
                const i = data.data.indexOf(employee) + 1;
                return (
                  <tr
                    key={employee.id}
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleDeleteClick(employee.id, employee.employee_name)
                          }
      ...
      <Modal
        ...
        description={`Are you sure you want to delete "${selectedEmployeeName}"? This action cannot be undone.`}
        variant="danger"

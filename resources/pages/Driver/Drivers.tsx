...
function Drivers() {
  ...
  return (
    <DashboardLayout pageTitle="Drivers" breadcrumb="Dashboard · Drivers">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm mt-1">
            Manage all registered operational drivers.
          </p>
        </div>
        <div className="w-full sm:w-auto">
          <Button
            ...
            onClick={() => navigate("/dashboard/drivers/create")}
            icon={
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {data?.data.map((driver: Driver) => {
                const i = data.data.indexOf(driver) + 1;
                return (
                  <tr
                    key={driver.id}
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleDeleteClick(driver.id, driver.driver_name)
                          }
      ...
      <Modal
        ...
        title="Delete Driver"
        description={`Are you sure you want to delete "${selectedDriverName}"? This action cannot be undone.`}
        variant="danger"

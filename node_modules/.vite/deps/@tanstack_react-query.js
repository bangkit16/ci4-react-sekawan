import {
  require_jsx_runtime
} from "./chunk-JXLFN7K7.js";
import {
  require_react
} from "./chunk-CM7VMBUQ.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
var Mutation = (_a7 = class extends Removable {
  ...
  async execute(variables) {
    var _a13, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
    const onContinue = () => {
    ...
    try {
      if (restored) {
        ...
        const context = await ((_c = (_b = this.options).onMutate) == null ? void 0 : _c.call(
          _b,
          variables,
          mutationFnContext
        ));
      ...
      await ((_e = (_d = __privateGet(this, _mutationCache).config).onSuccess) == null ? void 0 : _e.call(
        _d,
        data,
        variables,
        this.state.context,
      ...
      await ((_g = (_f = this.options).onSuccess) == null ? void 0 : _g.call(
        _f,
        data,
        variables,
        this.state.context,
      ...
      await ((_i = (_h = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _i.call(
        _h,
        data,
        null,
      ...
      await ((_k = (_j = this.options).onSettled) == null ? void 0 : _k.call(
        _j,
        data,
        null,
        variables,
      ...
      try {
        await ((_m = (_l = __privateGet(this, _mutationCache).config).onError) == null ? void 0 : _m.call(
          _l,
          error,
          variables,
          this.state.context,
      ...
      try {
        await ((_o = (_n = this.options).onError) == null ? void 0 : _o.call(
          _n,
          error,
          variables,
          this.state.context,
      ...
      try {
        await ((_q = (_p = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _q.call(
          _p,
          void 0,
          error,
          this.state.variables,
      ...
      try {
        await ((_s = (_r = this.options).onSettled) == null ? void 0 : _s.call(
          _r,
          void 0,
          error,
          variables,
...
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  getOptimisticResult(queries, combine) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, _combineResult, combineResult_fn).call(this, r != null ? r : result, combine, queryHashes);
      },
      () => {
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  if (defaultedOptions.experimental_prefetchInRender && !isServer && willFetch(result, isRestoring)) {
    const promise = isNewCacheEntry ? fetchOptimistic(defaultedOptions, observer, errorResetBoundary) : query == null ? void 0 : query.promise;
